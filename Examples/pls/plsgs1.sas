...
/*                                                               */
/*     NAME: plsgs1                                              */
/*    TITLE: Example for pls Action                              */
/*  PRODUCT: VIYA Statistics                                     */
/*   SYSTEM: ALL                                                 */
/*     KEYS: Regression Analysis                                 */
/*    PROCS: pls action set; pls action                          */
/*     DATA:                                                     */
/* LANGUAGE: PROC CAS                                            */
/*                                                               */
/*     MISC:                                                     */
...
/* Example: Predicting Biological Activity */

title 'Predicting Biological Activity';
...
proc cas;
   action pls.pls /
      ...
      model={depVars={'ls', 'ha', 'dt'},
             effects={'v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8',
